...
/*   Updated: 2024/05/31 14:00:52 by smonte-e         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T>
static void merge(typename T::iterator left, typename T::iterator middle, typename T::iterator right)
{
    T leftHalf(left, middle);
    T rightHalf(middle, right);
...
template <typename T>
static void insertionSort(typename T::iterator left, typename T::iterator right)
{
    for (typename T::iterator it = left; it != right; ++it)
    {
        typename T::value_type key = *it;
