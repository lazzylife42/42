...
/*   Updated: 2024/03/12 14:19:15 by smonte-e         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3d.h"

void	p_map_init(t_cube *cube)
{
	int	i;
	int	width;
	int	height;
...
void	p_map_to_tab(char *file, t_cube *cube)
{
	char	*buff;
	int		i;
	int		fd;
...
void	p_map_renderer_init(t_cube *cube, char **argv)
{
	(void)argv;
	p_map_init(cube);
	p_map_to_tab(argv[1], cube);
